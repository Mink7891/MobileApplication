...
//        Получение и отправка данных (2)
        mHandler	=	new	Handler(Looper.myLooper())	{
            public	void	handleMessage(Message	msg)	{
                ...
                // Ожидание заданного количества лет (времени задержки)
                try {
                    Thread.sleep(age * 1000); // Переводим возраст в миллисекунды
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }

                Log.d("Work", "Your age: " + age +" Your occupation: " + occupation);
