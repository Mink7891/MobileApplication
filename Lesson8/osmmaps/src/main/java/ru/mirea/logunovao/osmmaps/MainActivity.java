package ru.mirea.logunovao.osmmaps;
...
import ru.mirea.logunovao.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void funcAll(){
        ...
        setMarker("Соборная палата", new GeoPoint(55.782311, 37.617989));
        setMarker("Шуховская башня", new GeoPoint(55.719807, 37.688370));
    }
}